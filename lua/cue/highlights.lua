...
function M.setup()
	...
	-- Review artifacts: blue, the one palette entry no live group uses. Orange
	-- is CueModeReview (a session-mode axis), and reusing it here would blur
	-- the type/mode distinction the same way kind/mode already forbids.
	vim.api.nvim_set_hl(0, "CueCategoryReview", { fg = COLORS.blue, bold = false })
